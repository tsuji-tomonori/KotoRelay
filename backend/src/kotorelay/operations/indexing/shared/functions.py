...
from kotorelay.operations.indexing.shared.generated import queries as q
...
def purge(ctx: Context, job: models.OutboxRow, engine: Engine) -> str:
    ...
    sources: list[
        tuple[
            list[models.ChunksRow]
            | list[models.AssetsRow]
            | list[models.OcrRunsRow]
            | list[models.DraftsRow]
            | list[models.VersionsRow],
            str,
        ]
    ] = [
        (chunks, "body_key"),
