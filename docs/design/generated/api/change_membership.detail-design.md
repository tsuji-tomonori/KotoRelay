...
| backend/src/kotorelay/generated/queries.py:412 | db.query('operations/groups/sql/departments_get.sql', {'organization_id': organization_id, 'id': id}, DepartmentsRow) |
...
| backend/src/kotorelay/generated/queries.py:457 | db.execute('operations/groups/sql/memberships_insert.sql', row.model_dump()) |
...
| backend/src/kotorelay/generated/queries.py:471 | db.execute('operations/groups/sql/memberships_update.sql', row.model_dump()) |
...
| backend/src/kotorelay/generated/queries.py:509 | db.query('operations/identity/sql/users_get.sql', {'organization_id': organization_id, 'id': id}, UsersRow) |
