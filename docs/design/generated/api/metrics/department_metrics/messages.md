...
| 項目 | 値 |
| --- | --- |
| operation | department_metrics |
| endpoint | GET /api/metrics/{department_id} |
| router | backend/src/kotorelay/operations/metrics/department_metrics/router.py |
