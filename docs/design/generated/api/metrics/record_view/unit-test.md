...
対象: `backend/src/kotorelay/operations/metrics/functions.py:18`。式: `previous`
...
対象: `backend/src/kotorelay/operations/metrics/functions.py:14`。式: `bool(doc.latest_version_id)`
...
対象: `backend/src/kotorelay/operations/metrics/functions.py:15`。式: `ctx.member(data.department_id)`
...
対象: `backend/src/kotorelay/operations/metrics/functions.py:19`。式: `previous[0].document_id == doc.id and previous[0].department_id == data.department_id and (previous[0].kind == 'view')`
