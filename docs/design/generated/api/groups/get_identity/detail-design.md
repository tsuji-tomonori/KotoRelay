...
| query | DB対象 | 処理 |
| --- | --- | --- |
| kotorelay.operations.groups.get_identity.generated.queries.departments_list | departments | SELECT |
...
| backend/src/kotorelay/operations/groups/get_identity/router.py:23 | build_response(f.build_get_identity(ctx)) |
