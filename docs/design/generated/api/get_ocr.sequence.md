...
| kotorelay.operations.images.functions.authorize_asset | 146 | If | version_id is None |
| kotorelay.operations.images.functions.authorize_asset | 161 | Return | asset |
| kotorelay.operations.images.functions.ocr | 174 | If | version_id |
| kotorelay.operations.images.functions.ocr | 183 | Return | OcrResult.model_validate_json(ctx.objects.get(run.result_key, run.result_hash)) |
