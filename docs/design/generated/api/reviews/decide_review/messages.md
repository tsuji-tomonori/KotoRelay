...
| endpoint | POST /api/reviews/{submission_id}/decision |
...
| Problem | 403 | self_approval | 自分が作成した版は承認できません。 | KR_HTTP_REJECTED |
...
| Problem | 422 | reason_required | 理由を入力してください。 | KR_HTTP_REJECTED |
