...
対象: `backend/src/kotorelay/operations/documents/read_document/functions.py:12`。式: `bool(rows)`
...
対象: `backend/src/kotorelay/operations/documents/read_document/functions.py:14`。式: `doc.status != 'deleted'`
...
対象: `backend/src/kotorelay/operations/documents/read_document/functions.py:15`。式: `ctx.can_read(doc) or ctx.permission(doc.department_id, 'draft')`
...
対象: `backend/src/kotorelay/operations/documents/read_document/functions.py:17`。式: `chosen is not None`
