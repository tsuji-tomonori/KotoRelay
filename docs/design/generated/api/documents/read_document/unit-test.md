...
対象: `backend/src/kotorelay/operations/documents/read_document/functions.py:22`。式: `bool(rows)`
...
対象: `backend/src/kotorelay/operations/documents/read_document/functions.py:32`。式: `ctx.can_read(doc) or ctx.permission(doc.department_id, 'draft')`
...
対象: `backend/src/kotorelay/operations/documents/read_document/functions.py:27`。式: `doc.status != 'deleted'`
...
対象: `backend/src/kotorelay/operations/documents/read_document/functions.py:37`。式: `chosen is not None`
