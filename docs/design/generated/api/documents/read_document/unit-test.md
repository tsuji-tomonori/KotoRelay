...
対象: `backend/src/kotorelay/operations/documents/functions.py:265`。式: `bool(rows)`
...
対象: `backend/src/kotorelay/operations/documents/functions.py:267`。式: `doc.status != 'deleted'`
...
対象: `backend/src/kotorelay/operations/documents/functions.py:268`。式: `ctx.can_read(doc) or ctx.permission(doc.department_id, 'draft')`
...
対象: `backend/src/kotorelay/operations/documents/functions.py:270`。式: `chosen is not None`
