...
対象: `backend/src/kotorelay/operations/documents/submit_version/functions.py:20`。式: `cached`
...
対象: `backend/src/kotorelay/operations/documents/submit_version/functions.py:23`。式: `row.revision == data.revision`
...
対象: `backend/src/kotorelay/operations/documents/submit_version/functions.py:29`。式: `ocr.confirmed and ocr.status == 'ready'`
