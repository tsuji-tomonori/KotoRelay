...
## documents/submit_version/assets_get.sql

正本: `backend/src/kotorelay/operations/documents/submit_version/sql/assets_get.sql`
...
## documents/submit_version/documents_update.sql

正本: `backend/src/kotorelay/operations/documents/submit_version/sql/documents_update.sql`
...
## documents/submit_version/drafts_list.sql

正本: `backend/src/kotorelay/operations/documents/submit_version/sql/drafts_list.sql`
...
## documents/submit_version/ocr_runs_get.sql

正本: `backend/src/kotorelay/operations/documents/submit_version/sql/ocr_runs_get.sql`
...
## documents/submit_version/submissions_insert.sql

正本: `backend/src/kotorelay/operations/documents/submit_version/sql/submissions_insert.sql`
...
## documents/submit_version/versions_insert.sql

正本: `backend/src/kotorelay/operations/documents/submit_version/sql/versions_insert.sql`
