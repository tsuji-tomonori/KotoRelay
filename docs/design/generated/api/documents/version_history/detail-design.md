...
| backend/src/kotorelay/operations/documents/version_history/functions.py:12 | [{'version': v, 'submission': submissions.get(v.id)} for v in sorted(q.versions_list(ctx.db, ctx.org), key=lambda v: v.number, reverse=True) if v.document_id == doc.id] |
| backend/src/kotorelay/operations/documents/version_history/generated/queries.py:14 | db.query('operations/documents/version_history/sql/submissions_list.sql', {'organization_id': organization_id}, SubmissionsRow) |
| backend/src/kotorelay/operations/documents/version_history/generated/queries.py:23 | db.query('operations/documents/version_history/sql/versions_list.sql', {'organization_id': organization_id}, VersionsRow) |
...
| backend/src/kotorelay/operations/documents/version_history/router.py:23 | build_response(f.history(ctx, str(document_id))) |
