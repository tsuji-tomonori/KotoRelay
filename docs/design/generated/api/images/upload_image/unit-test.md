...
対象: `backend/src/kotorelay/operations/images/upload_image/functions.py:61`。式: `0 < len(data) <= max_bytes`
...
対象: `backend/src/kotorelay/operations/images/upload_image/functions.py:64`。式: `source.format in {'PNG', 'JPEG'} and source.width * source.height <= max_pixels and (max(source.width, source.height) <= 8000)`
...
対象: `backend/src/kotorelay/operations/images/upload_image/functions.py:77`。式: `len(value) <= max_bytes`
...
対象: `backend/src/kotorelay/operations/images/upload_image/functions.py:99`。式: `text`
...
対象: `backend/src/kotorelay/operations/images/upload_image/functions.py:23`。式: `len(assets) < ctx.settings.max_document_images`
