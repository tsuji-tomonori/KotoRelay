...
| endpoint | POST /api/images/documents/{document_id} |
...
| KR_OCR_FAILED | ERROR | OCRエンジンの実行が失敗しました。 |
...
| Problem | 422 | invalid_image | PNG/JPEGの許可サイズ内の画像を指定してください。 | KR_HTTP_REJECTED |
| Problem | 422 | invalid_image | 画像を読み取れません。 | KR_HTTP_REJECTED |
