...
| kotorelay.operations.images.get_image.functions.has_requested_version | 16 | Return | bool(version_id) |
| kotorelay.operations.images.get_image.response_builders.build_response | 10 | Return | Response(value, media_type='image/png') |
| kotorelay.operations.images.get_image.router.get_image | 31 | Return | build_response(f.get_get_image(asset, ctx)) |
