...
対象: `backend/src/kotorelay/operations/indexing/list_jobs/functions.py:12`。式: `ctx.user.operator`
...
対象: `backend/src/kotorelay/operations/indexing/list_jobs/functions.py:32`。式: `details`
