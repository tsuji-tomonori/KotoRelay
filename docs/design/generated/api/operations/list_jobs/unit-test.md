...
対象: `backend/src/kotorelay/operations/indexing/list_jobs/functions.py:18`。式: `ctx.user.operator`
...
対象: `backend/src/kotorelay/operations/indexing/list_jobs/router.py:26`。式: `details`
