...
| backend/src/kotorelay/operations/documents/functions.py:247 | doc.revision == data.revision | 'conflict' | 409 |
| backend/src/kotorelay/operations/documents/functions.py:249 | set(data.shared_departments) <= departments | 'forbidden' | 422 |
...
| backend/src/kotorelay/operations/documents/functions.py:276 | updated |
| backend/src/kotorelay/operations/documents/router.py:76 | f.policy(ctx, str(document_id), data) |
