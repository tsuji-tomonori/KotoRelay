...
| backend/src/kotorelay/operations/images/functions.py:70 | OcrResult(regions=regions, engine='tesseract-jpn-eng-v1', status='ready') |
| backend/src/kotorelay/operations/images/functions.py:54 | OcrResult(regions=[], engine='tesseract-jpn-eng-v1', status='failed') |
| backend/src/kotorelay/operations/images/functions.py:110 | {'asset': asset, 'ocr_run': run, 'ocr': result} |
